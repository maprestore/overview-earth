...
const OverviewReplay = (() => {
  ...
  const articles = [
    ['Infrastructure signals converge around the North Atlantic', 'North Atlantic', 'REPLAY FIXTURE', 45, -35],
    ['Seismic activity remains concentrated along the Pacific Rim', 'Pacific Rim', 'REPLAY FIXTURE', 35, 145],
    ['Orbital and terrestrial systems share one visible surface', 'Global', 'REPLAY FIXTURE', null, null],
    ['Public feeds become more useful when provenance stays attached', 'Global', 'REPLAY FIXTURE', null, null],
    ['A source-aware console separates observation from interpretation', 'Global', 'REPLAY FIXTURE', null, null]
  ].map(([title, country, domain, sourceLat, sourceLon], index) => ({
